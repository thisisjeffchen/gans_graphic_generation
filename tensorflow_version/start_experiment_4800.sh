...
python3 prep_data.py --experiment=${DATE}_${CAT}_${IMAGEDIR}_07_epochs_1000_batch_size_256_gen_updates_${GEN_UPDATES}_caption_len_4800 --cat=${CAT} --image_dir=Data/mscoco_raw/${IMAGEDIR}
